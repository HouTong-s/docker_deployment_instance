import { Form, Input, Button, Spin,message ,Image, InputNumber} from 'antd';
import 'antd/dist/antd.css';
import React from 'react';
import axios from 'axios';
import {Navigate,useNavigate,useLocation} from "react-router-dom";
import { v4 as uuidv4 } from 'uuid';
class StudentsLogin extends React.Component
{
    constructor(props)
    {
        super(props);
    ...
    render() {
        if(this.state.hasLoggedin)
        {
            ...
            return <Navigate 
            transitionName=""
            maskTransitionName="" to='/students'></Navigate>
        }
        return(
        <Spin spinning={this.state.loading}>
            <br/>
            <h1 style={{"textAlign":'center',"fontSize":"25px"}}>学生登录</h1>
            <br/>
        <Form
        ref={this.myref}
        name="basic"
