...
namespace CoreAPIs.Controllers.StudentControllers
{
    ...
    public class GetLessonsController : ControllerBase
    {
        ...
        // GET: api/students/GetLessons
        [HttpGet]
        /*
         *@TODO:获取可选的课程（可能是新修的也可能是重修的，取决于当前时间）
         *@param  null
         *@return 
         *成功返回Lessons_info对象
         *失败返回状态码
         */
        public async Task<ActionResult<Lessons_info>> GetLessons()
        {
            ...
            if (information.SelectStatus == 1)//新修
            {
                ...
                return new Lessons_info
                {
                    lessons = lessons,
                    begin_time = (DateTime)begin_time,
                    end_time = (DateTime)end_time,
                    select_type = "新修选课"
                };
            }
            else if(information.SelectStatus ==2)//重修
            {
